...
const Introduction = () => {
    return (
        <section className="flex flex-column align-items-center justify-content-center text-center py-8 px-4 bg-light" style={{ backgroundColor: '#1c1c1c', color: '#FFF' }}>
            <h1 className="text-5xl md:text-6xl font-bold mb-4" style={{ color: '#2196F3' }}>
